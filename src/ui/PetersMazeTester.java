...
public class PetersMazeTester extends JPanel implements MouseWheelListener,ActionListener{
	...
	Inventory inventory=new Inventory(new Player(300, 300, 1, 64, 64,this,this));
	ArsenalMenu arsenal;
	InventoryMenu menu;
	public PetersMazeTester(JFrame w) {
		this.addMouseWheelListener(this);
		clock.start();
		input=new PlayerInputParser(w,this);
		Item test=new Consumable("Baklava",0,10,64,null);
